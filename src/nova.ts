...
export type AssistantsRegistrySelector = string | { syntax: string };
...
export type AssistantArray<T> = ReadonlyArray<T> | Promise<ReadonlyArray<T>>;
...
export interface IssueAssistant {
  provideIssues(editor: TextEditor): AssistantArray<Issue>;
}

export type ResolvedTaskAction = TaskCommandAction | TaskProcessAction;
...
export type ColorFormat = "rgb" | "hsl" | "hsb" | "p3" | "hex";
...
export interface CommandsRegistry {
  ...
  invoke(name: string, ...args: Transferrable[]): Promise<unknown>;
  invoke(
    name: string,
...
export declare class CompositeDisposable extends Disposable {
  constructor();
...
export type ConfigurationValue = string | number | string[] | boolean;
...
export declare class Emitter extends Disposable {
  constructor();
...
export interface FileBinaryMode extends File {
  read(size?: number): ArrayBuffer | null;
}

export interface FileTextMode extends File {
...
export declare class IssueCollection {
...
export interface ProcessMessage<P, R, E> {
...
export type TaskName = string & { __type: "TaskName" };
...
export declare class TaskCommandAction {
...
export declare class TaskResolvableAction<T extends Transferrable> {
...
export interface TreeDataProvider<E> {
...
export declare class TreeView<E> extends Disposable {
  constructor(
    identifier: string,
